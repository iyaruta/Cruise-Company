...
Требования: java 8, сервлет контейнер tomcat/jetty, maven.
...
```
mvn clean install
rm $CATALINA_HOME/webapps/cruise-company-1.0-SNAPSHOT.war
cp target/cruise-company-1.0-SNAPSHOT.war $CATALINA_HOME/webapps
```